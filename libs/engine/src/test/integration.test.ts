...
integrationTest('polynomial:sub(2*x + y, -2*y + 3*x)', '3 * y + (-x)');
integrationTest('polynomial:sub(-2*y + 3*x, 2*x + y)', 'x + (-3) * y');
integrationTest('polynomial:sub(x^2 + 2*x + y -3, -2*y + 3*x)', 'x^2 + 3 * y + (-x) + -3');
integrationTest('polynomial:sub(1, 2)', '-1');
...
integrationTestThrow('polynomail:div(x,y)');
