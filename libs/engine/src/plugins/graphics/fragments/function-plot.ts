...
__FUNCTIONS.plot &&
    functionPlotFragment.addFunction(
        'plot',
        plotHeader,
        'Creates a plot of the function f in the range xMin to xMax on the x-axis. Default value for xMin is -10. Default value for xMax is 10.',
        'Erzeugt einen Plot der Funktion f im Bereich xMin bis xMax auf der x-Achse. Der Standardwert für xMin ist -10. Der Standardwert für xMax ist 10,',
