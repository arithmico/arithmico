...
export default function PrivacyPolicy() {
  return (
    <Container>
      ...
      <p>
        At Arithmico, accessible from https://arithmico.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        Arithmico and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Arithmico. This policy is not applicable to any
      ...
      <p>
        Arithmico follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, Arithmico uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertising partners of Arithmico.
      </p>
      ...
      <p>
        Note that Arithmico has no access to or control over these cookies that
      ...
      <p>
        Arithmico's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Arithmico does not knowingly collect any Personal Identifiable
