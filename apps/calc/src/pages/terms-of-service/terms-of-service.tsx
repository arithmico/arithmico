  ...
  return (
    <Container>
      ...
      <p>
        ...
        on Arithmico's Website for personal, non-commercial transitory viewing
      ...
      <p>
        ...
        and the{" "}
        <Link href="https://www.generateprivacypolicy.com">
      ...
      <p>
        All the materials on Arithmico’s Website are provided "as is". Arithmico
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, Arithmico does not make any
      ...
      <p>
        Arithmico or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        Arithmico’s Website, even if Math Explorer or an authorize
      ...
      <p>
        ...
        Arithmico may change the materials contained on its Website at any time
        without notice. Arithmico does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        Arithmico has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by Arithmico of the site. The use
