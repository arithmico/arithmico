...
addPluginFunction(
    absPlugin,
    createPluginFunction('abs', absHeader, 'Computes the absolute value of a number', (parameters, context) => {
...
addPluginFunction(
    absPlugin,
    createPluginFunction('length', lengthHeader, 'Computes the length of a vector', (parameters, context) => {
