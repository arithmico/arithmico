  ...
  return (
    <Container>
      ...
      <p>
        ...
        Beacons that are used in their respective advertisements and links that appear on Math
        Explorer, which are sent directly to users' browser. They automatically receive your IP
