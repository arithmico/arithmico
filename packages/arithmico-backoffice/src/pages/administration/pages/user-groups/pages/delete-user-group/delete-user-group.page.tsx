      ...
      {isSuccess && data && (
        <>
          ...
          <p className={classNames("max-w-5xl")}>
            <FormattedMessage id="administration.user-groups.delete.description" />
          </p>
          <div className={classNames("flex", "mt-4", "max-w-5xl")}>
            ...
            >
              <span aria-hidden>
                <FormattedMessage id="administration.user-groups.delete.action" />
              </span>
              <span className="sr-only">
                <FormattedMessage id="administration.user-groups.delete.sr-action" />
              </span>
            </button>
          </div>
        </>
