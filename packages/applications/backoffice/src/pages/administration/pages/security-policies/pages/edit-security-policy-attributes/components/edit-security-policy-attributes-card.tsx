        ...
        <div className={classNames("flex", "flex-col")}>
          <div className={classNames("my-4")}>
            <Heading level={3} className={classNames("text-lg")}>
              <FormattedMessage id="administration.security-policies.edit-attributes.summary" />
            </Heading>
            <ul className={classNames("[&>li]:ml-2", "[&>li]:text-sm")}>
              <li>
                <FormattedMessage
                  id="administration.security-policies.edit-attributes.removed-attributes"
                  values={{ count: removedAttributes.length }}
                />
              </li>
              <li>
                <FormattedMessage
                  id="administration.security-policies.edit-attributes.added-attributes"
